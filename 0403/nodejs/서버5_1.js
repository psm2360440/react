...
//http://127.0.0.1:4371/add?x=4&y=5
//http://127.0.0.1:4371/sub?x=4&y=5
//http://127.0.0.1:4371/userinfo?userid=test&username=Tom
...
server.listen(4371, ()=>{
    console.log( "server start http://127.0.0.1:4371");
});