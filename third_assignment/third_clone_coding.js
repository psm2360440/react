...
var guestbookList=[
    ...
    {"id":2, "title":"제목2", "writer":"작성자2", "contents":"내용2", "wdate":"2023-04-05"},
    {"id":3, "title":"제목3", "writer":"작성자3", "contents":"내용3", "wdate":"2023-04-06"},
    {"id":4, "title":"제목4", "writer":"작성자4", "contents":"내용4", "wdate":"2023-04-07"},
    {"id":5, "title":"제목5", "writer":"작성자5", "contents":"내용5", "wdate":"2023-04-08"}
];
...
app.post("/write", (req,res)=>{
    ...
    var id = guesbookList.length +1;

    guestbookList.push( {title:title, contents:contents, writer:writer, wdate:wdate, id:id});
});

app.listen(4370, function(){
    console.log("Example app listening on port 4370!");
})